...
public class UserApplication {
    private static final int serverPort = 38039;
    private static final int clientPort = 48039; 
    private static final int copterPort = 48078;
    private static final String Name = "Session2";
    
    private static String echo_code = "E6055";
    private static final String image_code = "M4958";
    private static final String sound_code = "A9810";
    //private static final String copter_code = "Q6635";
    private static final String obd_code = "V8022";  
    ...
    public static void main(String[] args) throws IOException{
      ...
      try {
        ...
        if(newSession.exists()){
            System.out.println("File already exists: " + newSession.getName());
        }else{
            newSession.mkdir();
    ...
    public static void EchoRequest() throws IOException{
        ...
        try {
            ...
            while (System.currentTimeMillis() - start < 250000) {
              try {
                s.send(p);
    ...
    public static void Sound_DPCM() throws IOException{
      ...
      try {
        ...
        try{
          samples.write(audio_out.getBytes());
          samples.close();
    ...
    public static void Sound_AQDPCM() throws IOException{
      ...
      try {
        String packetInfo = sound_code + "L20AQF999";
        byte[] rxbuffer = new byte[2048];
        byte[] txbuffer = packetInfo.getBytes();
        byte[] hostIP = { (byte)155,(byte)207,18,(byte)208 };
        InetAddress hostAddress = InetAddress.getByAddress(hostIP);
    ...
    */
    ...
    private static byte[] makeBytes(ArrayList<Byte> b) {
